...
public class SerialRPacket implements Runnable, SerialPortEventListener {
...
////////////////// members //////////////////////
    ...
    SerialRPListener listener = null;

////////////////// methods //////////////////////

//    public SerialRPacket() 
//    public void run() 
...
////////////////// processPacket //////////////////////
  ...
  public void processPacket() {
    ...
    if (listener != null) {
      listener.processRPacket(packetBuffer, packetSize);
    }
...
//                 if (portId.getName().equals("COM1")) {
                 if (portId.getName().equals("COM4")) {
                    SerialRPacket reader = new SerialRPacket("COM4");
                }
            }
        }
    }
...
////////////////// constructor //////////////////////
  ...
  public SerialRPacket(String ComPortId) {
...
//        if (portId.getName().equals("COM3")) { 
    ...
    try {
      serialPort = (SerialPort) portId.open("SerialRPacket", 2000);
...
////////////////// serialEvent //////////////////////
 ...
 ///////////////////// Debug ///////////////////////
  ...
  public void dbg(String s) {
    ...
    System.out.println("SerialRPacket." + (dcnt++) + ": " + s);
  } 
}
