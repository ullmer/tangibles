...
def synthFlangedPipe(od1, od2, id, pipeLen, flangeLen): #od2 > od1, for flanges
  outerCyl1 = cylinder(r=od1/2., h=pipeLen)
  innerCyl1 = cylinder(r=id/2.,  h=pipeLen*2)
  innerCyl2 = translate([0,0,-pipeLen/2.])(innerCyl1)

  outerFlange1a = cylinder(r1=od2/2., r2=od1/2., h=flangeLen)
  #outerFlange1b = translate([0, 0, -pipeLen/2.-flangeLen/2])(outerFlange1a)
  #outerFlange1b = translate([0, 0, -pipeLen/2.])(outerFlange1a)
  outerFlange1b = translate([0, 0, 0])(outerFlange1a)

  outerFlange2a = cylinder(r1=od1/2., r2=od2/2., h=flangeLen)
  #outerFlange2b = translate([0, 0, pipeLen+flangeLen/2])(outerFlange1a)
  outerFlange2b = translate([0, 0, pipeLen-flangeLen])(outerFlange2a)

  flangedPipe = (outerCyl1 + outerFlange1b + outerFlange2b) - innerCyl2
  return flangedPipe
